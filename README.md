...
本项目提供了对 [Claude Code](https://docs.anthropic.com/en/docs/claude-code) 的原生支持。Claude Code 是 Anthropic 推出的 AI 编码助手，能够理解项目上下文并提供智能编码辅助。

#### 使用方式

1. **自动识别**: Claude Code 会自动读取项目根目录的 `CLAUDE.md` 文件，了解项目结构和编码规范
2. **项目上下文**: `CLAUDE.md` 包含完整的项目架构、技术栈、编码规范和开发流程
3. **智能辅助**: Claude Code 将根据配置文件提供符合项目规范的代码建议

#### CLAUDE.md 内容概览

- **项目结构**: 完整的目录结构和模块说明
- **技术栈**: 后端(Java/Spring Boot)、前端(Vue 3)、移动端(uni-app)技术栈
- **编码规范**: 分层架构原则、命名规范、注释规范
- **开发流程**: 功能开发、前端开发、移动端开发的标准流程
- **质量保障**: 代码审查检查项和测试要求
- **常用命令**: 构建、运行、测试等常用命令

#### 自定义配置

团队可以根据项目需求修改 `CLAUDE.md` 文件，添加:
- 项目特定的业务规则
- 团队编码规范补充
- 自定义的技术栈配置
- 特殊的部署要求
